...
$customers = new User(new File(__DIR__.'/../src/files/users.txt'));
$registeredCustomers = $customers->getAllRegisteredCustomers();
?>
<!DOCTYPE html>
<html
                            ...
                            <div class="flex gap-x-4">
                              ...
                              <div class="flex-auto min-w-0">
                                <p
                                  ...
                                  <a href="./customer_transactions.php/<?php echo $customer['id'] ?>/<?php echo $customer['email'] ?>">
                                    <span
                                ...
                                <p class="flex mt-1 text-xs leading-5 text-gray-500">
                                  <a
                                    href="./customer_transactions.php/<?php echo $customer['id'] ?>/<?php echo $customer['email'] ?>"
